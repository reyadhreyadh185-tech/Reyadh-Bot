...
async function buildLobby(b) {
  ...
  await cmd(b, `/fill ${cx} ${cy+gateH+3} ${cz-R} ${cx} ${cy+gateH+3} ${cz-R} beacon`);
  ...
  await cmd(b, `/fill ${cx-R} ${cy+gateH+3} ${cz} ${cx-R} ${cy+gateH+3} ${cz} beacon`);
